window.addEventListener('load', () => {
	...
	let tabsAmount = document.querySelector('#inpTabs').value
	document.querySelector('#inpTabs').addEventListener('input', (e) => {
		tabsAmount = Math.max(Math.min(e.target.value, 15), 1)
		e.target.value = tabsAmount
	...
	function buildDigestListElements() {
